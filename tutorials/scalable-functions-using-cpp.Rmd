---
title: "Building scalable functions for R using C/C++"
...
## A test example: Simple rescaling function
...
Clearly, our C++ function is much faster at calculating the rescaled values over the 1000 calculations. Now let's make a much larger vector sampled from a probability distribution and compare the performance:

```{r message = FALSE, warning = FALSE}
# Generate some synthetic data

x1 <- rnorm(n = 1e9, mean = 5, sd = 2)
